...
namespace WorldCitiesAPI.Data
{
    ...
    {
        /// <summary>
        /// Private constructor calle by the CreateAsync method
        /// </summary>
        ...
        #region Methods
        /// <summary>
        /// Pages and/or sorts and/or filters an IQueryable source.
        /// </summary>
        ...
        /// <param name="filterQuery">The filtering query (value lookup)</param>
        /// <returns>
        /// An object containg the IQueryable paged/sorted results and all the relevant
        /// paging/sorting navigation info.
        /// </returns>
        ...
        {
            if (!string.IsNullOrEmpty(filterColumn) && !string.IsNullOrEmpty(filterQuery) && IsValidProperty(filterColumn)) { source = source.Where(string.Format("{0}.StartsWith(@0)", filterColumn), filterQuery); }
        ...
        public static bool IsValidProperty(string propertyName, bool throwExceptionIfNotFound = true)
        {
            ...
            if (prop == null && throwExceptionIfNotFound) { throw new NotSupportedException(string.Format($"ERROR: Property '{propertyName}' does not exist.")); }
            return prop != null;
        }
        #endregion Methods
        ...
        /// FALSE otherwise.
        /// </summary>
        public bool HasNextPage { get => ((PageIndex + 1) < TotalPages); }
